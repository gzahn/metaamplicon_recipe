...
ord1 / ord2 / ord3
ggsave("./output/figs/ordinations.png",dpi=500,width = 6,height = 8)
...
# Island appears to be a significant indicator of community structure...
...
ggsave("./output/figs/bbdml_plot_all_sig_taxa.png",height = 6, width = 8)
